...
Go to `https://principaltasksai.com/connect` and enter the connection code shown by the installer.

## The account is not found

Use the same email address used for PrincipalTasksAI signup or purchase. Manual license-key entry is available only as a fallback.
